...
```
Final-Project-Code-Files/
├── Final_Review_Report.docx        ← full written report (read this first)
├── README.md                       ← this file
│
